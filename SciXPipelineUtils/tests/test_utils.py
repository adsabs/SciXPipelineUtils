...
class test_utils_get_schema(TestCase):
    def test_get_schema(self):
        ...
        VALUE_SCHEMA_FILE = "SciXPipelineUtils/tests/stubdata/AVRO_schemas/TEMPLATEInputSchema.avsc"
...
class test_utils_get_config(TestCase):
    def test_load_config(self):
        ...
        config_dict = {'PROJ_HOME': '/Users/sao/ADS_repos/backoffice/SciXPipelines/SciXPipelineUtils/SciXPipelineUtils/tests/stubdata', 'AWS_ACCESS_KEY_ID': 'CHANGEME', 'AWS_BUCKET_ARN': 'BUCKETARN', 'AWS_BUCKET_NAME': 'BUCKETNAME', 'AWS_DEFAULT_REGION': 'us-east-1', 'AWS_SECRET_ACCESS_KEY': 'SECRETS', 'KAFKA_BROKER': 'kafka:9092', 'LOGGING_LEVEL': 'INFO', 'LOG_STDOUT': True, 'MINIO_ACCESS_KEY_ID': 'admin', 'MINIO_BUCKET_NAME': 'scix-TEMPLATE', 'MINIO_S3_URL': 'http://minio:9000', 'MINIO_SECRET_ACCESS_KEY': 'supersecret', 'PROFILE_NAME': 'SESSION_PROFILE', 'REDIS_HOST': 'localhost', 'REDIS_PORT': 6379, 'S3_PROVIDERS': ['AWS', 'MINIO'], 'SCHEMA_REGISTRY_URL': 'http://schema-registry:8081', 'SQLALCHEMY_ECHO': False, 'SQLALCHEMY_URL': 'postgresql://template:TEMPLATE@localhost:5432/template', 'TEMPLATE_INPUT_SCHEMA': 'TEMPLATEInputSchema', 'TEMPLATE_INPUT_TOPIC': 'TEMPLATEInput', 'TEMPLATE_OUTPUT_SCHEMA': 'TEMPLATEOutputSchema', 'TEMPLATE_OUTPUT_TOPIC': 'TEMPLATEOutput'}
